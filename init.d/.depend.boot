TARGETS = mountkernfs.sh hostname.sh udev keyboard-setup mountdevsubfs.sh hwclock.sh hdparm checkroot.sh checkfs.sh checkroot-bootclean.sh kmod mountall.sh mountall-bootclean.sh urandom procps pppd-dns udev-finish networking rpcbind nfs-common mountnfs.sh mountnfs-bootclean.sh kbd console-setup x11-common alsa-utils virtualbox-guest-x11 bootmisc.sh screen-cleanup lm-sensors
